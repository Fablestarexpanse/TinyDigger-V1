...
Usage: python td_stamp_clean.py depth.png out.png [--size 512] [--blur 1.5] [--border 0.08] [--no-centre]
...
def clean(depth, size, blur, border, centre):
...
def main():
    ...
    h = clean(depth, a.size, a.blur, a.border, not a.no_centre)
